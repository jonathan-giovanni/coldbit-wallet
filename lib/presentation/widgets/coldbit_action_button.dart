...
class _ColdBitActionButtonState extends State<ColdBitActionButton> {
  ...
  Widget build(BuildContext context) {
    final bgColor = widget.isPrimary ? ColdBitTheme.goldBitcoin : Colors.transparent;
    final textColor = widget.isPrimary ? ColdBitTheme.obsidianBlack : ColdBitTheme.goldBitcoin;
    final borderColor = widget.isPrimary ? Colors.transparent : ColdBitTheme.goldBitcoin;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: widget.isPrimary && !_isPressed ? ColdBitTheme.glowShadow : null,
