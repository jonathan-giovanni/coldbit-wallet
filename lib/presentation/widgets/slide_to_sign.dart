            ...
            Center(
              child: _isSigning
                  ? const SizedBox(
                      height: 24,
                      width: 24,
                      child: CircularProgressIndicator(color: ColdBitTheme.goldBitcoin, strokeWidth: 2),
                    )
                  : Text(
                      'SLIDE TO SIGN',
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: ColdBitTheme.goldBitcoin.withValues(alpha: 0.4),
                        blurRadius: 10,
                        spreadRadius: 2,
                      ),
                    ],
                  ),
                  child: const Icon(LucideIcons.fingerprint, color: ColdBitTheme.obsidianBlack),
                ),
              ),
            ),
          ],
